  ...
  return (
    <group>
      <group ref={body}>
        ...
        <Sph p={[0.56, 0.2, 0.14]} rad={0.03} c="#15110e" />
        <Sph p={[0.33, 0.26, 0.24]} rad={0.08} sc={[0.8, 1.2, 0.5]} c="#8a5433" />
        <Box p={[0.44, 0.26, 0.2]} s={[0.06, 0.012, 0.012]} c="#15110e" />
      </group>
      ...
      {[0, 1, 2].map((i) => (
        <group key={i} ref={(g) => void (zs.current[i] = g)}>
          <Box p={[0, 0.05, 0]} s={[0.1, 0.018, 0.018]} c="#15110e" />
          <Box r={[0, 0, 0.8]} s={[0.018, 0.13, 0.018]} c="#15110e" />
          <Box p={[0, -0.05, 0]} s={[0.1, 0.018, 0.018]} c="#15110e" />
        </group>
      ))}
    </group>
...
function CafeTable({ p }: { p: [number, number, number] }) {
  return (
    <group position={p}>
      ...
      <Cyl p={[0, 0.4, 0]} rt={0.05} h={0.75} c="#15110e" />
      <Cyl p={[0, 0.02, 0]} rt={0.3} h={0.04} c="#15110e" />
      {[0, Math.PI].map((a) => (
        <group key={a} rotation={[0, a + 0.5, 0]}>
          <Box p={[0.95, 0.45, 0]} s={[0.45, 0.06, 0.45]} c="#2f8f5b" />
          <Box p={[1.15, 0.75, 0]} s={[0.06, 0.6, 0.45]} c="#2f8f5b" />
          <Box p={[0.95, 0.22, 0]} s={[0.05, 0.45, 0.05]} c="#15110e" />
        </group>
      ))}
    </group>
  );
    ...
    <group>
      ...
      {[-3.2, -2.2, -1.2].map((x) => (
        <group key={x} position={[x, 0, -2.45]}>
          ...
          <Cyl p={[0, 0.35, 0]} rt={0.03} h={0.7} c="#15110e" />
        </group>
      ))}
