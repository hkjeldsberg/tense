  ...
  return (
    <group>
      ...
      <group>
        ...
        <Box p={[0, 1.85, 0]} s={[0.42, 0.7, 0.3]} c="#15110e" />
...
function Decor() {
  return (
    <group>
      ...
      {/* departures board */}
      <Box p={[-1.3, 2.8, -3.95]} s={[2.4, 1.0, 0.1]} c="#15110e" />
      {[0.25, 0, -0.25].map((y, i) => (
        <group key={y}>
      ...
      <group position={[0.3, PLATFORM, -3.3]}>
        ...
        <Box p={[-0.8, 0.22, 0]} s={[0.08, 0.45, 0.45]} c="#15110e" />
        <Box p={[0.8, 0.22, 0]} s={[0.08, 0.45, 0.45]} c="#15110e" />
      </group>
      {/* lamp posts */}
      {[-2.2, 2.2].map((x) => (
        <group key={x} position={[x, PLATFORM, 1.3]}>
          <Cyl p={[0, 1.3, 0]} rt={0.05} h={2.6} c="#15110e" />
