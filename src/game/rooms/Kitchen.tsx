  ...
  return (
    <group>
      <group ref={body}>
        ...
        <Box p={[-0.02, 0.62, 0]} s={[0.36, 0.05, 0.06]} c="#15110e" />
        <Box p={[-0.18, 0.52, 0]} s={[0.05, 0.2, 0.06]} c="#15110e" />
        <Box p={[0.14, 0.52, 0]} s={[0.05, 0.2, 0.06]} c="#15110e" />
      </group>
      <group ref={lid} position={[0, 0.5, 0]}>
        <Cyl rt={0.13} rb={0.15} h={0.05} c="#b8322f" />
        <Sph p={[0, 0.05, 0]} rad={0.04} c="#15110e" />
      </group>
      {[0, 1, 2].map((i) => (
...
function Cat() {
  return (
    <group position={[0.55, 0.9, 0.35]} rotation={[0, 0.6, 0]}>
      ...
      <Sph p={[-0.05, 0.52, 0.21]} rad={0.022} c="#15110e" />
      <Sph p={[0.05, 0.52, 0.21]} rad={0.022} c="#15110e" />
